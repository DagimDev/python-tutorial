...
# input to a program). After each inputted item, display the total cost of all items inputted thus far, 
...
def main():
    ...
    while True:
        try:
            ...
            # User pressed Ctrl+D, exit the program
            print()
            break
        except KeyError:
            # Item not in menu, ignore and continue
            pass
