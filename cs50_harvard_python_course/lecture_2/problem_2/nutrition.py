...
# fruits exactly as written in the poster (e.g., strawberries, not strawberry). Ignore any input that isn’t
# a fruit.
...
# Calories: 50
# Run your program with python nutrition.py. Type Sweet Cherries and press Enter. Your program should 
# output
# Calories: 100

def main():
    # Dictionary of fruits and their calories (from FDA poster)
    fruits = {
        "apple": 130,
        "avocado": 50,
        "banana": 110,
    ...
    # Check if fruit is in dictionary
    if fruit in fruits:
